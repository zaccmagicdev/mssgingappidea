      ...
      <div className='login-landing-page__container'>
        <div className='login-landing-page__section login-landing-page__section_register'>
          <form className='login-landing-page__form'>
            ...
            <label className='login-landing-page__label' for="register-username">
              <input className='login-landing-page__input' type='text' id='register-username' placeholder='Username' required minLength='5' maxLength='16' />
            </label>
            <label className='login-landing-page__label' for="register-password">
              <input className='login-landing-page__input' type='password' id='register-password' placeholder='Password' required minLength='8' maxLength='20' />
            </label>
            <label className='login-landing-page__label' for="register-dob">
              <input type="date" id="register-dob" max="2012-01-01" min="1941-01-01" />
            </label>
            <ButtonRipple className='login-landing-page__link' id='register-submit'>Sign Up</ButtonRipple>
          </form>
        </div>
        <div className='login-landing-page__section login-landing-page__section_login'>
          <form className='login-landing-page__form'>
            ...
            <label className='login-landing-page__label' for="login-username">
              <input className='login-landing-page__input' type='text' id='login-username' placeholder='Username' required minLength='5' maxLength='16' />
            </label>
            <label className='login-landing-page__label' for="login-password">
              <input className='login-landing-page__input' type='password' id='login-password' placeholder='Password' required minLength='8' maxLength='20' />
            </label>
            <ButtonRipple className='login-landing-page__link' id='sign-in-submit'>Sign In</ButtonRipple>
          </form>
        </div>
